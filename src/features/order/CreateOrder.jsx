  ...
  return (
    <div className="px-4 py-6">
      ...
      <Form method="POST">
        ...
        <div className="mb-5 flex flex-col gap-2 sm:flex-row sm:items-center">
          <label className="sm:mt-2 sm:mb-auto sm:basis-40">Phone number</label>
          <div className="grow">
        ...
        <div className="relative mb-5 flex flex-col gap-2 sm:flex-row sm:items-center">
          ...
          {!position && (
            <span className="absolute top-[35px] right-[3px] z-50 sm:top-[1px] md:top-[5px] md:right-[5px]">
              <Button
                type="small"
                onClick={(e) => {
                  e.preventDefault();
...
export async function action({ request }) {
  ...
  if (!isValidPhone(order.phone)) {
    errors.phone =
      "Please provide a correct phone number. We might need to contact you.";
  }
